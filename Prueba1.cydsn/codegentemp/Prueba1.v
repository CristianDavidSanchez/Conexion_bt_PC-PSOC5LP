// ======================================================================
// Prueba1.v generated from TopDesign.cysch
// 01/20/2021 at 15:54
...
module top ;
	...
	wire [0:0] tmpOE__OUTS_net;
	wire [0:0] tmpFB_0__OUTS_net;
	wire [0:0] tmpIO_0__OUTS_net;
	wire [0:0] tmpINTERRUPT_0__OUTS_net;
	electrical [0:0] tmpSIOVREF__OUTS_net;
	...
	cy_psoc3_pins_v1_10
		...
		OUTS
		 (.oe(tmpOE__OUTS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OUTS_net[0:0]}),
		  .io({tmpIO_0__OUTS_net[0:0]}),
		  .siovref(tmpSIOVREF__OUTS_net),
		  .interrupt({tmpINTERRUPT_0__OUTS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUTS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("0ca11b21-edac-445a-9628-c3e0e93c1491"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
